...
public class BookingDao {
	...
	public Booking bookingOrderConsultant(int userId, int consultantId) {
		...
		Consultant consultant = consultantRepository
				...
				.orElseThrow(() -> new ConsultantNotFoundException("Consultant with the ID "+consultantId+" is not found"));
	...
	public Booking searchBookingOrder(int bookingId) {
		return bookingRepository
				.findById(bookingId)
				.orElseThrow(() -> new BookingNotFoundException("Consultant booking with ID "+bookingId+" is not found"));
	}
